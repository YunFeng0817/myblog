# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-08-25 04:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(null=True, to='blog.comment')),
            ],
            options={
                'ordering': ['-writeDate'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('comments', models.ManyToManyField(null=True, to='blog.comment')),
                ('files', models.ManyToManyField(null=True, to='blog.file')),
                ('images', models.ManyToManyField(null=True, to='blog.image')),
                ('labels', models.ManyToManyField(null=True, to='blog.label')),
            ],
            options={
                'ordering': ['-writeDate'],
                'abstract': False,
        ...
        migrations.AddField(
            model_name='diary',
            name='files',
            field=models.ManyToManyField(null=True, to='blog.file'),
        ),
        migrations.AddField(
            model_name='diary',
            name='images',
            field=models.ManyToManyField(null=True, to='blog.image'),
        ),
        migrations.AddField(
            model_name='diary',
            name='labels',
